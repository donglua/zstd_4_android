 ...
 * Signature: ([BI[BIILcom/github/luben/com.github.luben.zstd/ZstdDictDecompress;)J
 */
 ...
 * Class:     com_github_luben_zstd_Zstd
 * Method:    compressFast
 * Signature: ([BI[BIILcom/github/luben/com.github.luben.zstd/ZstdDictCompress;)J
 */
