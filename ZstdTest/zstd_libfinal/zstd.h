...
/*******************************************************************************************************
  ...
  com.github.luben.zstd, short for Zstandard, is a fast lossless compression algorithm, targeting real-time compression scenarios
  at zlib-level and better compression ratios. The com.github.luben.zstd compression library provides in-memory compression and
  ...
  Advanced experimental functions can be accessed using #define ZSTD_STATIC_LINKING_ONLY before including com.github.luben.zstd.h.
...
***************************************/
/*! ZSTD_compress() :
    Compresses `src` content as a single com.github.luben.zstd compressed frame into already allocated `dst`.
...
*
*   'src' is the start of a com.github.luben.zstd compressed frame.
...
/**
    ...
    Block functions produce and decode raw com.github.luben.zstd blocks, without frame metadata.
...
/*=====   Raw com.github.luben.zstd block functions  =====*/
